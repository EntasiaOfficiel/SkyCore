		...
		new BukkitRunnable(){
			...
			public void run() {
				try {
					...
					genDimension(link.is, Dimensions.OVERWORLD.world, type.schems);
...
//					sp.p.sendMessage("§6Génération end terminée !");
	...
	protected static void genBaseDimension(BaseIsland is, World w, IslandShematics isc) throws Throwable {
		...
		// FILL OVERWORLD
		EditSession editSession = TerrainManager.getSession(w);
		TerrainManager.clearTerrain(is, editSession);
